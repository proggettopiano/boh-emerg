...
export default function Login() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const from = location.state?.from || (r.data.user.profile_completed ? "/" : "/profile-setup");
  ...
  return (
    <AuthShell title="Accedi" subtitle="Apri la tua libreria di spartiti." testId="login-page">
      <button onClick={googleLogin} className="w-full border-2 border-ink py-3 rounded-md font-medium flex items-center justify-center gap-3 hover:bg-canvas3 transition-colors mb-6" data-testid="login-google-btn">
        <svg width="18" height="18" viewBox="0 0 48 48"><path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.4 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.3 6.1 29.4 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.4-.4-3.5z"/><path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16 19 13 24 13c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.3 7.1 29.4 5 24 5 16.3 5 9.7 9.3 6.3 14.7z"/><path fill="#4CAF50" d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.2c-2 1.4-4.6 2.4-7.3 2.4-5.3 0-9.7-3.5-11.3-8.4l-6.6 5.1C9.6 39.7 16.2 44 24 44z"/><path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.6l6.3 5.2C42 35 44 30 44 24c0-1.3-.1-2.4-.4-3.5z"/></svg>
        Continua con Google
      </button>
