...
export default function Login() {
  ...
  return (
    <AuthShell title="Accedi" subtitle="Apri la tua libreria di spartiti." testId="login-page">
      <button onClick={googleLogin} disabled={busy || googleBusy} className="w-full border-2 border-ink py-3 rounded-md font-medium flex items-center justify-center gap-3 hover:bg-canvas3 transition-colors mb-6 disabled:cursor-not-allowed disabled:opacity-50" data-testid="login-google-btn">
