...
export default function ViewerToolbar({
  ...
  return (
    <header className="viewer-toolbar" data-testid="viewer-toolbar">
      <div className={`viewer-toolbar-controls ${search.isSearchActive ? "viewer-toolbar-search-active" : ""}`}>
        <div className="viewer-toolbar-group flex-1 min-w-0 items-center gap-2">
        ...
        <div className="viewer-toolbar-group flex items-center gap-1 shrink-0">
        ...
        {search.isSearchActive && (
          <div className="viewer-toolbar-group viewer-toolbar-group--search min-w-full" data-testid="viewer-search-bar">
